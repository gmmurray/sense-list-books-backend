...
class DefaultBULI {
    constructor(userList, userId, notes, bookListItem, status, owned, rating) {
    ...
    static createDefault(userId, userListId, bookListItemId) {
        return new DefaultBULI(new mongoose_1.Types.ObjectId(userListId), userId, '', new mongoose_1.Types.ObjectId(bookListItemId), userListItemStatus_1.BookReadingStatus.notStarted, false, null);
    }
}
