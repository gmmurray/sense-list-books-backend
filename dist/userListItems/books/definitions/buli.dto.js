...
class BULIDto extends userListItem_dto_1.UserListItemDto {
    constructor(bookListItem, status, owned, baseProperties, rating) {
        super();
...
class CreateBULIDto {
    constructor(userList, userId, bookListItem, status, owned, rating, notes) {
...
class PatchBULIDto {
    constructor({ notes = undefined, status = undefined, owned = undefined, rating = undefined, }) {
        this.notes = notes;
        this.status = status;
        this.owned = owned;
        this.rating = rating;
